...
const translations = {
  ...
  en: {
    ...
    heroCopy: "Integrated cultural merchandise solutions from strategy, design and IP development to supply chain, quality control and delivery.",
    ...
    aboutTitle: "Design-led innovation that turns brand ideas into deliverable products.",
    aboutCn: "WOWTOO serves brand clients across industries with integrated project management and execution for corporate merchandise, promotional derivatives, IP products and retail product development.",
    aboutEn: "Guided by integrity, innovation, professionalism and excellence, WOWTOO connects creative strategy, visual design, supplier resources, quality control and logistics to help brands launch products that are practical, memorable and manufacturable.",
    servicesTitle: "One-stop brand merchandise development",
    servicesLead: "From concept planning to mass delivery, each stage is handled by dedicated teams and traceable workflows.",
    ...
    service3Title: "Supply Development",
    service3Text: "Matching supplier resources across plush, vinyl toys, bags, stationery, home goods, packaging, digital accessories and craft gifts.",
    ...
    processTitle: "A project path from requirement confirmation to sales conversion",
    processLead: "WOWTOO breaks creative service into manageable nodes: requirement confirmation, product approval, sampling, brand authorization use, channel confirmation, quality control, warehousing and sales conversion.",
    step1Title: "Requirement Confirmation",
    ...
    qualityTitle: "Managing project certainty with the 3C standard",
    qualityLead: "Progress control, creative control and quality control run through the entire project. Supplier audits cover preparation, execution, audit reports, corrective actions and follow-up verification.",
    ...
    downloadText: "Get the complete WOWTOO profile covering the team, service system, design capabilities, supply chain, quality control and selected case pages.",
    downloadMeta: "47 pages · Company profile",
    downloadButton: "Download PDF",
    joinTitle: "Join Us",
    joinText: "If you care about brands, design, products and supply-chain execution, work with WOWTOO to turn creative ideas into products people actually use.",
    ...
    optionPromo: "Promotional Derivatives",
